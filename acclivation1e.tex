...
%\begin{tabular}{ll}
%\subfloat[phfunc]{\includegraphics[width=.4\textwidth]{rzwavy-phfunc.png}} &
%\subfloat[vfunc]{\includegraphics[width=.4\textwidth]{rzwavy-vfunc.png}} \\
%\subfloat[phrange]{\includegraphics[width=.4\textwidth]{rzwavy-phrange.png}} &
%\subfloat[graph]{\includegraphics[width=.4\textwidth]{rzwavy-graph.png}} \\
%\end{tabular}
\begin{tabular}{lll}
