...
faced by the knobs---that is, to make it more hill-shaped. That is, for as
long as the global fitness function provides opportunity for distorting it to
make knob-turning mutations improve fitness, the graph experiences pressure to
evolve those distortions as a side-effect of responding to its own virtual
fitness function.
...
upward paths more easily and hence so does the organism as a whole. A synergy
