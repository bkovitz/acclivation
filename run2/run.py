...
def main():
    paramss = [
      ...
      ['--c1_lb=0.3 --c1_ub=0.7', '--c1_lb=0.2 --c1_ub=0.8', '--c1_lb=0.1 --c1_ub=0.9'],
      ['--extra_mutation_rate=0.1', '--extra_mutation_rate=0.2'],
      ['--mutation_type_ub=10', '--mutation_type_ub=16', '--mutation_type_ub=22'],
      ...
      ['--num_epochs=20', '--num_epochs=60', '--num_epochs=100'],
    ]
